...
## Kernkonzept: Klassifikationen als PIM-Bordmittel
...
│  └──────────────────┴──────────────────┴──────────────────┘ │
│                                                             │
│  KI-Vorschläge (optional, Claude API):                      │
│  → Analysiert Namen, Datentyp, Einheit, Beispielwerte       │
│  → Schlägt Zuordnung mit Konfidenz vor                      │
...
### Vorhandene PIM-Features die das ermöglichen
...
// Request:
{
    ...
    "target_node_id": "uuid-etim-EC001234"           // optional: Kontext-Klasse
}
