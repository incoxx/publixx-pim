...
| Selektor | Komponente | Datei |
|----------|-----------|-------|
| `nav-products` | Produkte-Link in Sidebar | `pim-frontend/src/components/layout/AppSidebar.vue` |
| `nav-hierarchies` | Hierarchien-Link in Sidebar | `pim-frontend/src/components/layout/AppSidebar.vue` |
| `nav-search` | Suche-Link in Sidebar | `pim-frontend/src/components/layout/AppSidebar.vue` |

## Dashboard

| Selektor | Komponente | Datei |
|----------|-----------|-------|
| `dashboard` | Dashboard Root-Container | `pim-frontend/src/views/dashboard/DashboardView.vue` |

## Produkte

| Selektor | Komponente | Datei |
|----------|-----------|-------|
| `product-list` | Produktliste Root-Container | `pim-frontend/src/views/products/ProductListView.vue` |
...
| `product-detail` | Produktdetail Root-Container | `pim-frontend/src/views/products/ProductDetailView.vue` |
