...
use App\Http\Controllers\Api\V1\DemoVideoController;
...
use App\Http\Controllers\Api\V1\SecurityGuardController;
...
Route::prefix('v1')->middleware(['auth:sanctum', 'throttle.pim'])->group(function () {
    ...
    Route::prefix('tms')->group(function () {
        ...
        Route::patch('units/{id}', [TmsProxyController::class, 'updateUnitMetadata'])
            ->where('id', '[a-f0-9\-]{36}');
    ...
    // =====================================================================
    // Admin: Security Guard (Angriffs-Erkennung, System → Guard)
    // =====================================================================
    Route::get('admin/security-guard', [SecurityGuardController::class, 'show']);
    Route::put('admin/security-guard', [SecurityGuardController::class, 'update']);
    Route::get('admin/security-guard/events', [SecurityGuardController::class, 'events']);
    Route::get('admin/security-guard/stats', [SecurityGuardController::class, 'stats']);
