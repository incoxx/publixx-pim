...
import { useUserAuditStore } from '@/stores/userAudit'
import { useAuthStore } from '@/stores/auth'
import usersApi from '@/api/users'
import PimTable from '@/components/shared/PimTable.vue'
import PimDeleteConfirmDialog from '@/components/shared/PimDeleteConfirmDialog.vue'

const store = useUserAuditStore()
...
const columns = [
  ...
  { key: 'auditable_id', label: 'Benutzer-ID', mono: true },
...
const actionColors = {
  ...
  logged_in: 'bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400',
}
...
<template>
  <div class="space-y-4">
    ...
    <div class="flex items-center justify-between">
      <h2 class="text-lg font-semibold text-[var(--color-text-primary)]">Benutzer-Audit-Trail</h2>
    ...
    <PimTable
      ...
      :showActions="false"
      emptyText="Keine Einträge im Benutzer-Audit-Trail"
      @sort="handleSort"
    >
    ...
    <PimDeleteConfirmDialog
      ...
      title="Benutzer-Audit-Trail löschen?"
      message="Alle Einträge im Benutzer-Audit-Trail werden unwiderruflich gelöscht."
      entityType="user-audit-logs"
      :loading="deleting"
