...
import { MapPin, Plus, Trash2, Save, X, GripVertical, ChevronLeft } from 'lucide-vue-next'
      ...
      <template v-else>
        <div class="flex flex-wrap items-center justify-between gap-2 mb-6">
          <div class="flex items-center gap-2 min-w-0">
            ...
            <h2 class="text-lg font-semibold truncate">{{ current.id ? current.name_de : 'Neue Adressart' }}</h2>
          </div>
          ...
          <div class="col-span-2">
            ...
            <div class="space-y-2">
              <div v-for="(field, idx) in current.field_schema" :key="idx"
                class="flex items-center gap-2 flex-wrap bg-base-200 rounded-lg px-3 py-2">
