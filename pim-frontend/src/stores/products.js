  ...
  async function fetchOne(id, options = {}) {
    ...
    try {
      const { data } = await productsApi.get(id, {
        include: 'attributeValues,variants,media,prices,productType,workflow,currentWorkflowStatus,workflowAssignee,workflowTeam,projects,masterHierarchyNode.hierarchy,tags',
        ...options,
      })
