...
import {
  ...
  FlaskConical, FileSpreadsheet, Plug, Wand2, Fingerprint, Tag,
  Folders, FileStack, Network, Images, Clapperboard, ShoppingCart, ShoppingBag,
  CreditCard, Boxes, Gauge, MapPin, ArrowDownUp, Key, Bot, Terminal, Bug, ShieldAlert,
...
const allItems = computed(() => {
  const items = [
    ...
    {
      id: 'nav-media-motifs', icon: Images,
      label: t('Motive'),
      description: t('cmd.desc.mediaMotifs'),
      keywords: ['motiv', 'motive', 'motif', 'rendition', 'variante', 'ausschnitt', 'crop'],
      section: 'navigation', action: () => router.push('/media-motifs'),
      permission: 'media.view',
    },
    {
      id: 'nav-collections', icon: Folders,
      label: t('Collections'),
      description: t('cmd.desc.collections'),
      keywords: ['collection', 'sammlung', 'mappe', 'zusammenstellung', 'set'],
      section: 'navigation', action: () => router.push('/collections'),
      module: 'collections', permission: 'collections.view',
    },
    {
      id: 'nav-content', icon: FileStack,
      label: t('Content'),
      description: t('cmd.desc.content'),
      keywords: ['content', 'inhalt', 'seite', 'page', 'redaktion', 'cms', 'website'],
      section: 'navigation', action: () => router.push('/content'),
      module: 'content', permission: 'content.view',
    },
    {
      id: 'nav-navigation', icon: Network,
      label: t('Sitemap'),
      description: t('cmd.desc.navigation'),
      keywords: ['sitemap', 'navigation', 'menü', 'menu', 'struktur', 'baum', 'tree'],
      section: 'navigation', action: () => router.push('/navigation'),
      module: 'content', permission: 'navigation.view',
    },
    {
      id: 'nav-website-preview', icon: Globe,
      label: t('Website-Vorschau'),
      description: t('cmd.desc.websitePreview'),
      keywords: ['website', 'vorschau', 'preview', 'seite', 'frontend', 'ansicht'],
      section: 'navigation', action: () => router.push('/website-preview'),
      module: 'content', permission: 'content.view',
    },
    {
      id: 'nav-social-video', icon: Clapperboard,
      label: t('Social-Video'),
      description: t('cmd.desc.socialVideo'),
      keywords: ['video', 'social', 'clip', 'reel', 'story', 'film'],
      section: 'navigation', action: () => router.push('/social-video'),
      permission: 'products.view',
    },
    {
      id: 'nav-ecommerce-cart-types', icon: ShoppingCart,
      label: t('Warenkörbe'),
      description: t('cmd.desc.ecommerceCartTypes'),
      keywords: ['warenkorb', 'cart', 'basket', 'shop', 'ecommerce', 'e-commerce'],
      section: 'navigation', action: () => router.push('/ecommerce/cart-types'),
      module: 'ecommerce', permission: 'ecommerce-cart-types.view',
    },
    {
      id: 'nav-ecommerce-address-types', icon: MapPin,
      label: t('Adressarten'),
      description: t('cmd.desc.ecommerceAddressTypes'),
      keywords: ['adresse', 'address', 'lieferung', 'delivery', 'rechnung', 'shop', 'ecommerce'],
      section: 'navigation', action: () => router.push('/ecommerce/address-types'),
      module: 'ecommerce', permission: 'ecommerce-address-types.view',
    },
    {
      id: 'nav-ecommerce-payment-types', icon: CreditCard,
      label: t('Zahlungsarten'),
      description: t('cmd.desc.ecommercePaymentTypes'),
      keywords: ['zahlung', 'payment', 'bezahlen', 'rechnung', 'shop', 'ecommerce'],
      section: 'navigation', action: () => router.push('/ecommerce/payment-types'),
      module: 'ecommerce', permission: 'ecommerce-payment-types.view',
    },
    {
      id: 'nav-ecommerce-orders', icon: ClipboardList,
      label: t('Bestellungen'),
      description: t('cmd.desc.ecommerceOrders'),
      keywords: ['bestellung', 'order', 'auftrag', 'shop', 'ecommerce'],
      section: 'navigation', action: () => router.push('/ecommerce/orders'),
      module: 'ecommerce', permission: 'ecommerce-orders.view',
    },
    {
    ...
    {
      id: 'cfg-tags', icon: Tag,
      label: t('nav.tags'),
      description: t('cmd.desc.tags'),
      keywords: ['tag', 'tags', 'schlagwort', 'schlagworte', 'stichwort', 'stichworte', 'keyword', 'keywords', 'label', 'verschlagwortung'],
      section: 'config', action: () => router.push('/tags'),
      permission: 'tags.view',
    },
    {
      id: 'cfg-reference-profiles', icon: Shield,
      label: t('Referenz-Profile'),
      description: t('cmd.desc.referenceProfiles'),
      keywords: ['referenz', 'reference', 'profil', 'profile', 'pflichtfeld', 'vorgabe', 'konformität'],
      section: 'config', action: () => router.push('/reference-profiles'),
      permission: 'reference-profiles.view',
    },
    {
      id: 'cfg-conformance-report', icon: FileBarChart,
      label: t('Konformitäts-Report'),
      description: t('cmd.desc.conformanceReport'),
      keywords: ['konformität', 'conformance', 'report', 'prüfung', 'vollständigkeit', 'qualität'],
      section: 'config', action: () => router.push('/conformance-report'),
      permission: 'conformance.view',
    },
    {
      id: 'cfg-languages', icon: Globe,
      label: t('Sprachen'),
      description: t('cmd.desc.languages'),
      keywords: ['sprache', 'language', 'locale', 'mehrsprachig', 'i18n', 'übersetzung'],
      section: 'config', action: () => router.push('/languages'),
    },
    {
      id: 'cfg-media-languages', icon: Languages,
      label: t('Medien-Sprachen'),
      description: t('cmd.desc.mediaLanguages'),
      keywords: ['medien', 'media', 'sprache', 'language', 'dokument', 'pdf'],
      section: 'config', action: () => router.push('/media-languages'),
      permission: 'media-languages.view',
    },
    {
      id: 'cfg-media-countries', icon: MapPin,
      label: t('Medien-Länder'),
      description: t('cmd.desc.mediaCountries'),
      keywords: ['medien', 'media', 'land', 'country', 'region', 'markt'],
      section: 'config', action: () => router.push('/media-countries'),
      permission: 'media-countries.view',
    },
    {
      id: 'cfg-collection-types', icon: Folders,
      label: t('Collection-Typen'),
      description: t('cmd.desc.collectionTypes'),
      keywords: ['collection', 'sammlung', 'typ', 'type', 'vorlage'],
      section: 'config', action: () => router.push('/collection-types'),
      module: 'collections', permission: 'collection-types.view',
    },
    {
      id: 'cfg-content-types', icon: LayoutTemplate,
      label: t('Seitentypen'),
      description: t('cmd.desc.contentTypes'),
      keywords: ['seitentyp', 'page type', 'content', 'vorlage', 'template', 'cms'],
      section: 'config', action: () => router.push('/content-types'),
      module: 'content', permission: 'content-types.view',
    },
    {
      id: 'cfg-section-types', icon: Boxes,
      label: t('Sektionstypen'),
      description: t('cmd.desc.sectionTypes'),
      keywords: ['sektion', 'section', 'block', 'baustein', 'content', 'cms'],
      section: 'config', action: () => router.push('/section-types'),
      module: 'content', permission: 'section-types.view',
    },
    {
      id: 'cfg-product-widgets', icon: LayoutGrid,
      label: t('Produkt-Widgets'),
      description: t('cmd.desc.productWidgets'),
      keywords: ['widget', 'produktblock', 'block', 'anzeige', 'content', 'cms'],
      section: 'config', action: () => router.push('/product-widgets'),
      module: 'content', permission: 'product-widgets.view',
    },
    {
      id: 'cfg-content-config', icon: ArrowRightLeft,
      label: t('Content Export / Import'),
      description: t('cmd.desc.contentConfig'),
      keywords: ['content', 'export', 'import', 'konfiguration', 'sichern', 'backup'],
      section: 'config', action: () => router.push('/content-config'),
      module: 'content', permission: 'content-types.view',
    },
    {
      id: 'cfg-content-cache', icon: Gauge,
      label: t('Content-Cache'),
      description: t('cmd.desc.contentCache'),
      keywords: ['cache', 'content', 'performance', 'leeren', 'flush', 'invalidieren'],
      section: 'config', action: () => router.push('/content-cache'),
      module: 'content', permission: 'content-types.view',
    },
    {
      id: 'cfg-typo3', icon: ExternalLink,
      label: t('Typo 3'),
      description: t('cmd.desc.typo3'),
      keywords: ['typo3', 'integration', 'cms', 'schnittstelle', 'content'],
      section: 'config', action: () => router.push('/content/integration/typo3'),
    ...
    {
      id: 'adm-connectors-shopify', icon: ShoppingBag,
      label: t('Shopify'),
      description: t('cmd.desc.connectorsShopify'),
      keywords: ['shopify', 'shop', 'connector', 'sync', 'ecommerce', 'schnittstelle'],
      section: 'admin', action: () => router.push('/connectors/shopify'),
      module: 'connectors', permission: 'connectors.view',
    },
    {
      id: 'adm-connectors-anypim', icon: ArrowDownUp,
      label: t('anyPIM Sync'),
      description: t('cmd.desc.connectorsAnypim'),
      keywords: ['anypim', 'sync', 'connector', 'abgleich', 'schnittstelle', 'instanz'],
      section: 'admin', action: () => router.push('/connectors/anypim'),
      module: 'connectors', permission: 'connectors.view',
    },
    {
      id: 'adm-connectors-api-keys', icon: Key,
      label: t('API-Keys'),
      description: t('cmd.desc.connectorsApiKeys'),
      keywords: ['api', 'key', 'schlüssel', 'token', 'zugang', 'connector'],
      section: 'admin', action: () => router.push('/connectors/api-keys'),
      module: 'connectors', permission: 'connectors.view',
    },
    {
      id: 'adm-mcp-playground', icon: Bot,
      label: t('MCP Playground'),
      description: t('cmd.desc.mcpPlayground'),
      keywords: ['mcp', 'playground', 'ki', 'ai', 'agent', 'tool', 'test'],
      section: 'admin', action: () => router.push('/mcp-playground'),
      module: 'api_designer', permission: 'api-templates.view',
    },
    {
      id: 'adm-artisan-cockpit', icon: Terminal,
      label: t('Artisan-Cockpit'),
      description: t('cmd.desc.artisanCockpit'),
      keywords: ['artisan', 'cockpit', 'command', 'befehl', 'konsole', 'wartung'],
      section: 'admin', action: () => router.push('/artisan-cockpit'),
      permission: 'users.view',
    },
    {
      id: 'adm-errors', icon: Bug,
      label: t('Fehlerliste'),
      description: t('cmd.desc.errors'),
      keywords: ['fehler', 'error', 'bug', 'exception', 'störung', 'problem'],
      section: 'admin', action: () => router.push('/errors'),
      permission: 'users.view',
    },
    {
      id: 'adm-security-guard', icon: ShieldAlert,
      label: t('Guard'),
      description: t('cmd.desc.securityGuard'),
      keywords: ['guard', 'sicherheit', 'security', 'schutz', 'angriff', 'überwachung'],
      section: 'admin', action: () => router.push('/security-guard'),
      adminOnly: true,
    },
    {
