  ...
  const all = [
    ...
    },
    {
      ...
      items: [
        ...
        { icon: Globe, label: () => t('Portale'), to: '/portal-config', module: 'portals', permission: 'portals.view' },
    ...
    },
    {
      ...
      items: [
        { icon: Settings, label: () => t('Plugin-Einstellungen'), to: '/plugin-settings', permission: 'users.view' },
        {
          ...
          children: [
            { icon: Send, label: () => t('Canva'), to: '/connectors/canva', module: 'connectors', permission: 'connectors.view' },
            ...
            { icon: Cloud, label: () => t('Salesforce Commerce'), to: '/connectors/salesforce-commerce', module: 'connectors', permission: 'connectors.view' },
            { icon: Image, label: () => t('Cloudinary'), to: '/connectors/cloudinary', module: 'connectors', permission: 'connectors.view' },
