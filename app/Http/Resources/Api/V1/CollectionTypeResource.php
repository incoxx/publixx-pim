...
class CollectionTypeResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'default_discount_attribute' => $this->default_discount_attribute,
            'default_line_text_attribute' => $this->default_line_text_attribute,
            'default_payment_terms_attribute' => $this->default_payment_terms_attribute,
            'default_cover_text_attribute' => $this->default_cover_text_attribute,
