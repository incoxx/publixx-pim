...
class ExportJobController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'catalog_template_id' => 'sometimes|string|nullable|exists:catalog_templates,id',
            'report_template_id' => 'sometimes|string|nullable|exists:report_templates,id',
            'pdf_template_id' => 'sometimes|string|nullable|exists:pdf_templates,id',
            'output_format' => 'sometimes|string|nullable|in:pdf,docx,indesign',
            'format' => 'required|string|in:json,excel,csv,xml,offline_catalog,report,pdf_template',
    ...
    public function update(Request $request, string $id): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'pdf_template_id' => 'sometimes|string|nullable|exists:pdf_templates,id',
            'output_format' => 'sometimes|string|nullable|in:pdf,docx,indesign',
            'format' => 'sometimes|string|in:json,excel,csv,xml,offline_catalog,report,pdf_template',
            'sections' => 'sometimes|array|nullable',
            'sections.*' => 'string',
            'filters' => 'sometimes|array|nullable',
            'cron_expression' => 'sometimes|string|nullable|max:100',
