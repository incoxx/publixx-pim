...
class UpdateNavigationNodeRequest extends FormRequest
{
    ...
    {
        return [
            'label_de' => 'sometimes|string|max:255',
            'label_en' => 'nullable|string|max:255',
            'label_json' => 'nullable|array',
            'slug' => 'nullable|string|max:255',
            'icon' => 'nullable|string|max:50',
            'is_visible' => 'sometimes|boolean',
            'target_type' => 'sometimes|in:folder,content_page,product_category,product,external_url',
