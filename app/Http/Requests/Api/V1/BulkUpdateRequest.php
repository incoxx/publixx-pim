...
class BulkUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'operations.attributes.*.attribute_id' => 'required_with:operations.attributes|string|uuid',
            ...
            'operations.relations.*.relation_type_id' => 'required_with:operations.relations|string|uuid',
            'operations.relations.*.target_product_id' => 'required_with:operations.relations|string|uuid',
            'operations.relations.*.action' => 'required_with:operations.relations|in:add,remove',

            // Output hierarchy
            'operations.output_hierarchy' => 'nullable|array',
            'operations.output_hierarchy.*.hierarchy_node_id' => 'required_with:operations.output_hierarchy|string|uuid',
            ...
            'operations.master_hierarchy_node_id' => 'nullable|string|uuid',

            // Media
            'operations.media' => 'nullable|array',
            'operations.media.*.media_id' => 'required_with:operations.media|string|uuid',
