...
class StoreAttributeRequest extends FormRequest
{
    ...
    {
        return [
            'technical_name' => 'required|string|max:100|unique:attributes,technical_name',
            'name_de' => 'required|string|max:255',
            'name_en' => 'nullable|string|max:255',
            'name_json' => 'nullable|array',
            'description_de' => 'nullable|string',
            'description_en' => 'nullable|string',
            'data_type' => 'required|in:String,Number,Float,Date,Flag,Selection,MultiSelection,Dictionary,Composite,RichText,Hyperlink,ImageLink,PdfLink,VideoLink,DelimitedValue,JsonArtefact',
            ...
            'is_multipliable' => 'required|boolean',
