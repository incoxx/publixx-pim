...
class StoreAttributeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'data_type' => 'required|in:String,Number,Float,Date,Flag,Selection,Dictionary,Composite,RichText,Hyperlink,ImageLink,PdfLink,VideoLink,DelimitedValue,JsonArtefact',
