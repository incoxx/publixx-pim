...
class UpdateAttributeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'data_type' => 'sometimes|in:String,Number,Float,Date,Flag,Selection,MultiSelection,Dictionary,Composite,RichText,Hyperlink,ImageLink,PdfLink,VideoLink,DelimitedValue,JsonArtefact',
