    ...
    private function computeEffectiveAttributes(HierarchyNode $node): Collection
    {
        ...
        $attributes = DB::table('hierarchy_node_attribute_assignments as hnaa')
            ...
            ->groupBy([
                ...
                'a.is_variant_attribute', 'a.is_internal', 'a.is_primary', 'a.is_multipliable', 'a.max_multiplied',
                ...
                'a.delimiter', 'a.textarea_rows', 'a.textarea_cols',
                'a.min_value', 'a.max_value', 'a.max_characters', 'a.is_readonly',
